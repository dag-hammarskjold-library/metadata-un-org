...
def get_dataset(endpoint, lang):
    '''
    This function is a special purpose fetch function for data sets in PoolParty
    '''
    jsresponse = requests.get(endpoint, auth=(API['user'], API['password']))
